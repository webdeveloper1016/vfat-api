...
var Provider = /** @class */ (function () {
    ...
    Provider.prototype.getEthBalance = function (address) {
        ...
        return (0, calls_1.getEthBalance)(address, (_a = this.multicall) === null || _a === void 0 ? void 0 : _a.address);
    };
    /**
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!this.multicall) {
                            console.log('Multicall contract is not available on this network, using deployless version.');
                        }
                        provider = this.provider;
                        return [4 /*yield*/, (0, call_1.all)(provider, this.multicall, calls, block)];
     ...
     * @param block  Block number for this call
     */
    Provider.prototype.tryAll = function (calls, block) {
        return __awaiter(this, void 0, void 0, function () {
            var provider;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!this.multicall2) {
                            console.log('Multicall2 contract is not available on this network, using deployless version.');
                        }
                        provider = this.provider;
                        return [4 /*yield*/, (0, call_1.tryAll)(provider, this.multicall2, calls, block)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
